...
function tightPlot3(name,chans,time,data1,data2,xMax)
    hFig = figure(1);
    set(hFig, 'Position', [2000 1000 637.5 825])    

    subtightplot(2,1,1,[0.05 0.00], [0.06 0.03], [0.08 0.08]);
...
%    set(gAxes,'Position',[.13,.8,.775,.21])
    ...
    set(t1,{'FontSize'},{10.0})
     ...
     subtightplot(2,1,2,[0.05 0.00], [0.06 0.03], [0.08 0.08]);
